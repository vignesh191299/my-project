                  ...
                  <Col>
                    <label>
                      ...
                      <Container  id="brandlist" style={{display:"none",padding:"20px 0px 0px 0px"}}>
                        <Row>
                          <Col>
                            <label className="f-container">Roadster
                              <input type="radio" className="inputradio" name="brand" value="Roadster" onChange={handleBrandChange} />
                              <span className="f-checkmark"></span>
                            </label>
                            <label className="f-container">Wrogn
                              <input type="radio" className="inputradio" name="brand" value="Wrogn" onChange={handleBrandChange} />
                              <span className="f-checkmark"></span>
                            </label>
                            ...
                            <label className="f-container">Nautica
                              <input type="radio" className="inputradio" name="brand" value="Nautica" onChange={handleBrandChange} />
                              <span className="f-checkmark"></span>
                            </label>
                          </Col>
                        </Row>
